...
class AddStudentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etStudentName.doOnTextChanged { _, _, _, _ ->
            tilName.error = null
        }

        etStudentPhone.doOnTextChanged { _, _, _, _ ->
        ...
        btnSaveStudent.setOnClickListener {
            ...
            btnSaveStudent.text = getString(R.string.adding_student)
    ...
    private fun showQrDialog(name: String, qrBitmap: Bitmap?) {
        ...
        if (qrBitmap != null) {
            ...
            Toast.makeText(this, getString(R.string.failed_qr), Toast.LENGTH_SHORT).show()
        }
